...
/>
                ...
                <div className="lg:w-1/3 ">
                    <p className='mb-8 mt-12'>Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua enim
...
/>
                              ...
                              <div className="">
                              <h4 className='text-semibold'>  Qualified Doctors</h4>
...
/>
                            ...
                            <div className="">
                            <h4 className='text-semibold'>Allergy Medicine</h4>
                                <p>Our clients and bring the best of who.</p>
                            </div>
                         ...
                         <p className='mt-8'>Quis ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor 
                            incididunt ut labore et dolore magna ipsum ultrices gravida.</p>
                            <h3 className='mt-8'>Do you have any Question?</h3>
                          <h1 className='text-semibold'>  +880 01892799999</h1>
                         <div className="mt-12">
                         <button className='btn bg-blue-300 flex text-white'>Contact Us<FaArrowRight></FaArrowRight></button>
                         </div>
                </div>
            </div>
        </div>
